...
public class TestRunCasesClass extends ReportingClass{
...
//	}
	...
	public void TestCase01_Candela_EDI_850_Shipments_Pre_Validation_Report() {
		...
		if(efrc.getTestData("Run Mode").equals("Y")&& efrc.getTestData("Status").equalsIgnoreCase("No Run")) {
			System.setProperty("webdriver.chrome.driver", "C:\\chromedriver\\Chromedriver124\\chromedriver-win64 (2)\\chromedriver-win64\\chromedriver.exe");
...
//	}
	...
	public static void main(String[] args) {
		  ...
		  testng.setTestClasses(new Class[] {TestRunCasesClass.class});
		  testng.run();
		 }
