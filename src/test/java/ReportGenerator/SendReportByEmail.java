...
import TestCases.TestRunCasesClass;
...
public class SendReportByEmail {
    ...
    public  void sendEmail(String strTo,String strFrom) {
        ...
        try {
			...
			email.setMsg("Hi Please find the Deatails of Automation  Execution Report\n1.No of Sceduled Processes Passed :  "+TestRunCasesClass.noOfTestCasesPass+"\n"
					+ "2.No of Scheduled Processes Failed:  "+TestRunCasesClass.noOfTestCasesFailed+"\n"
							+ "3.No of Scheduled Processes Skip:  "+TestRunCasesClass.noOfTestCasesSkiped+"\nThanks and Regards\nSwarup Kshatriya");
